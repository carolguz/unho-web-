...
const UNHO = {
  ...
  renderEquipo() {
    ...
    list.innerHTML = saved.map((m, i) => {
      const src = m.base64 || (m.driveId ? "https://drive.google.com/thumbnail?id=" + m.driveId + "&sz=w80" : "");
  ...
  previewEqFoto() {
    ...
    document.getElementById('eq-prev-img').src = "https://drive.google.com/thumbnail?id=" + id + "&sz=w200";
    document.getElementById('eq-foto-preview').style.display = 'flex';
  },
